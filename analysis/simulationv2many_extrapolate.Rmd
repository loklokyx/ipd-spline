...
### line plot
```{r, fig.width=10}
plots_many <- lapply(metrics, function(m) base_plot(df_plot_many, m, 
...
wrap_plots(
  list(plots_many[[1]], plots_many[[2]], plots_many[[3]]),
  ncol=3,
)
```
...
### CI True Value
```{r, fig.width=12}
plot_CI_many <- base_plot_CI(df_plot_many, ncol = 2, legend_ncol=4)
plot_CI_many
```