...
ggplot(df2_all, aes(x = Age, y = metric_value, color = method)) +
  # geom_line() +
  geom_point(data = subset(df2_all, method == "meta_re"), size = 1) +
  geom_line(data = subset(df2_all, method != "meta_re"), size = 1.3) +
...
ggplot(df2_all, aes(x = Age, y = mean_pred, color = method, 
                    fill = method)) +
  geom_point(data = subset(df2_all, method == "meta_re"), size = 1) +
  geom_line(data = subset(df2_all, method != "meta_re"), size = 1.3) +
